...
Google maps:
To test Google Maps API: go admin panel in http://www.kembasy.com/admin/dashboard  thenclick on the button customers geolocation. this youtube video show the test localy: https://youtu.be/vZZW9lDEZIk
